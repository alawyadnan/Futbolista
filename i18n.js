...
const messages = {
  en: {
    ...
    profile: "Player profile", backPlayers: "Players", comparePlayer: "Compare player", resultsRecord: "Results record", mostTeammates: "Most Teammates", recentMatches: "Recent matches", neverPlayed: "Never played with", loadingConnections: "Loading connections…", showAll: "Show all", showLess: "Show less", playerNotFound: "Player not found.",
  ...
  ar: {
    ...
    profile: "الملف الشخصي", backPlayers: "العودة إلى اللاعبين", comparePlayer: "مقارنة اللاعب", resultsRecord: "حصيلة النتائج", mostTeammates: "الأكثر لعبًا معه", recentMatches: "آخر المباريات", neverPlayed: "لم يشارك معهم", loadingConnections: "جارٍ تحميل بيانات الزملاء…", showAll: "عرض الكل", showLess: "عرض أقل", playerNotFound: "تعذر العثور على اللاعب.",
