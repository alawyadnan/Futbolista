...
const messages = {
  en: {
    ...
    adminAccountLead: "Player requests are in Admin. Session voting is in Entry.",
  ...
  ar: {
    ...
    adminAccountLead: "طلبات ربط اللاعبين في الإدارة، وفتح التصويت في الإدخال.",
